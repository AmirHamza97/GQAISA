...
void bent_cigar_func(double *, double *, int , double *,double *, int, int); /* Discus-----F1---- */
...
void rastrigin_func (double *, double *, int , double *,double *, int, int); /* Rastrigin's----------------->F2  */
void weierstrass_func (double *, double *, int , double *,double *, int, int); /* Weierstrass's------------->F3  */
...
void escaffer6_func (double *, double *, int , double *,double *, int, int); /* Expanded Scaffer¡¯s F6---------->F4  */
void step_rastrigin_func (double *, double *, int , double *,double *, int, int); /* Noncontinuous Rastrigin's  */
void happycat_func (double *, double *, int , double *,double *, int, int); /* HappyCat ------------------>F5*/
...
void hf04 (double *, double *, int, double *,double *, int *,int, int); /* Hybrid Function 4 --------27------>F6*/
void hf05 (double *, double *, int, double *,double *, int *,int, int); /* Hybrid Function 5 --------28------>F7*/
...
void cf03 (double *, double *, int , double *,double *, int); /* Composition Function 3 --------36----->F8*/
...
void cf07 (double *, double *, int , double *,double *, int); /* Composition Function 7 ---------40----->F9*/
void cf08 (double *, double *, int , double *,double *, int); /* Composition Function 8 ----------41---->F10*/
